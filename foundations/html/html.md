...
### DOM
Dom provides a way to manipulate these tree-nested object, such as search,add,lelete and so on. It's a glue layer providing a way that javascript can handle it.[W3 DOM](http://www.w3.org/DOM/)
