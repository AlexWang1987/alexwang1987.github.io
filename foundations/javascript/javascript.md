...
In javascript world, everything you can think is object, and all codes are organized in functions. So application is running by function invoking functions and so on. which form a stack.
