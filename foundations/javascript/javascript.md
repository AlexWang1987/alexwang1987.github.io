...
In javascript world, everything you can think is object, and all codes are organized in functions. So application is running by functions invoking functions and so on. which form a stack. when a function is called, it is insert into the top of stack and executed, it can return removing out of the stack or invoke others function on and on.
