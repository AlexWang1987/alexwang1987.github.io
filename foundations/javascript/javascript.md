...
```
See, Functional Scope Chain is very clear, In my scope, If I don't have just ask for it from parent and continue to its global scope. Here is problem. if we not use `var`, the global context will be wholly mess.
