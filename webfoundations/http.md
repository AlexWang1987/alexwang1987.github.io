...
Theoretically, Web server can provide any information through HTTP protocol, but here are some common types of resources.`html`,`jpeg`,`png`,`javascript`,`css`,`video`,`audios`,`pdf`,ect.
