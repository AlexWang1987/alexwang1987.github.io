...
* the benefit is that we can preserve **execution context** and restore it at appropriate time. This is exactly the base requirement for **asychronious programming**.
